...
public:
    ...
    void set_cast(string *new_cast) {string *aux; aux = this->cast; this->cast = new_cast; delete [] aux;}
    void set_n_platforms(int new_n_platforms) {this->n_platforms = new_n_platforms; }
    void set_platforms(char *new_platforms) {char *aux; aux = this->platforms; this->platforms = new_platforms; delete [] aux;}
...
float& Movie :: operator[] (int index){
    return marks[index];  /// am supraincarcat asa operatorul [] pentru a calcula mai usor ratingul filmului
